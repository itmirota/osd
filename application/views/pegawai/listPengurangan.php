...
<div class="col-md-12">
  <div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Data Karyawan Keluar Tahun <?=$year?></h3>
    </div><!-- /.box-header -->
    <div class="card-body table-responsive no-padding">
      <table id="dataTable" class="table table-hover">
        ...
        <tr>
          ...
          <td  class="text-center"><?= mediumdate_indo($data->tgl_keluar) ?></td>
          <td  class="text-center"><?= $data->alasan_keluar ?></td>
        </tr>
        <?php
          endforeach;
        }
