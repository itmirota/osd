          ...
          <tbody>
            ...
            foreach ($list_data as $d) { ?>
              <tr>
                ...
                <td>
                  <p class="m-0"><?= $d->nama_magang?></p>
                  <p class="m-0"><?= $d->bagian?></p>
                </td>
                <!-- <td><?= $d->kategori?></td> -->
                <td><?= $d->nama_jenis?></td>
                ...
                <td class="text-center"><a href="<?= base_url('hasil-magang/'.$d->id_evaluasi)?>"><i class="fa fa-solid fa-eye"></i></a></td>
                <td class="text-center"><a href="<?= base_url('penilaian-magang/'.$d->id_evaluasi)?>"><i class="fa fa-solid fa-pencil"></i> mulai</a></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
          <label for="pegawai_id" class="form-label">Bagian</label>
