<main class="d-flex w-100 theme-login">
  <div class="container d-flex flex-column">
    <div class="row vh-100">
      <div class="col-10 col-lg-4 mx-auto d-table h-100">
        <div class="d-table-cell align-middle">
          <div class="text-center mt-4">
            <h2 class="font-light"><strong>Selamat Datang!</strong></h2>
            <p class="font-light">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="m-sm-3 d-grid gap-2 mt-3">
                ...
                <button onclick="loginForm()" class="btn btn-sm btn-outline-dark"  id="BtnLoginUsername">
