      ...
      <div class="card-body table-responsive no-padding">
        <table id="dataTable" class="table table-hover">
          ...
          <tr>
            ...
            <td class="text-center"><?= $data->no_resi ?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-3" id="staticBackdropLabel">Edit Resi dan Harga</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="<?=base_url('satpam/updatePengiriman')?>" role="form" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="biaya_kirim" placeholder="biaya kirim" class="form-control tabel-PR" required />
          </div>
