  ...
  <div class="col-md-12">
    <div class="card card-primary">
      ...
      <div class="d-flex justify-content-start mb-4">
        <a href="<?= base_url('EvaluasiPromosi')?>" class="btn btn-warning"><i class="fa fa-angles-left"></i> kembali</a>
      </div>
      </div>
      ...
      <table class="table table-hover" id="dataTableScrollX">
          ...
          <tr>
            ...
            <th class="text-end">Performa</th>
            <th class="text-end">Keahlian dan Kompetensi</th>
            ...
            <th class="text-end">Loyalitas</th>
            <th class="text-end">Agility</th>
