  ...
  <div class="col-md-12">
    <div class="card card-primary">
      ...
      <div class="d-flex justify-content-between mb-4">
        ...
        <a href="<?= base_url('jadwal-evaluasi-promosi')?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
      </div>
      </div>
      <?php } ?>
          ...
          <tbody>
            <tr>
              ...
              <?php if ($role == ROLE_HRBP | $role == ROLE_HRGA | $role == ROLE_SUPERADMIN){ ?>
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#editData" onclick="editData(<?=$ld->id_evaluasiPromosi?>)" ><i class="fa fa-pencil"></i></a> 
                </td>
                <td class="text-center">
                <a href="<?= base_url('hasil-evaluasi-promosi/'.$ld->id_evaluasiPromosi)?>"><i class="fa fa-eye"></i></a> 
                </td>
              <?php } ?>
              <td class="text-center">
                <div class="">
                <a href="<?= base_url('penilaian-promosi/'.$ld->id_evaluasiPromosi)?>" target="_blank" class="btn btn-sm btn-success"><i class="fas fa-pencil"></i> penilaian</a>
                </div>
                <!-- <input type="text" value="<?= base_url('penilaian-promosi/'.$ld->id_evaluasiPromosi)?>" id="myInput">
...
<div class="modal fade" id="editData" tabindex="-1" aria-labelledby="addDepartementLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?= base_url('evaluasiPromosi/updateJadwalPenilaian')?>" role="form" method="post" enctype="multipart/form-data">
        <div class="card p-2">
          <div class="card-body">
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input type="hidden" name="id_evaluasiPromosi" id="id_evaluasiPromosi" class="form-control-plaintext tabel-PR" readonly required />
...
<script>
  function editData($id){
    $.ajax({
      url:"<?php echo site_url("evaluasiPromosi/detailEvaluasiPromosi")?>/" + $id,
      dataType:"JSON",
      type: "get",
      success:function(hasil){
        console.log(hasil);
        document.getElementById("id_evaluasiPromosi").value = hasil.id_evaluasiPromosi;
