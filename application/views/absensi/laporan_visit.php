          ...
          <div class="modal fade" id="filterAbsenToko" tabindex="-1" aria-labelledby="filterAbsenTokoLabel" aria-hidden="true">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form action="<?=base_url('Laporan-visit')?>" role="form" method="post" enctype="multipart/form-data">
        ...
        <table id="dataTable" class="table table-hover">
          ...
          ?>
            <tr>
              ...
              <td class="text-left">
              <p class="m-0"><strong>Nama Toko:</strong> <?= $ld->nama_toko?></p>
              <p><strong>Keterangan:</strong> <?= $ld->keterangan?></p>
              </td>
              <td>
                <a href="#" class="pop">
