<main class="d-flex w-100">
  <div class="container d-flex flex-column">
    <div class="col-md-8 col-lg-4 text-center mt-4 alert alert-primary mx-auto" role="alert">
    ...
    <div class="row">
      <div class="col-sm-10 col-lg-4 mx-auto d-table">
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-center">
                <img id="logo" src="<?= base_url('assets/images/osd.png')?>" style="max-width:300px; width:100%">
              </div>

              <div class="m-sm-3" id="formLogin">
                <h3 class="mx-auto text-center"> Form Login </h3>
              ...
              <div class="m-sm-3 d-grid gap-2 mt-3">
                <a href="<?=$this->userlogin->oauth2_google_admin()['urlOauth2']?>" class="btn btn-sm btn-outline-dark">
                ...
                <a href="#" onclick="loginForm()" class="btn btn-sm btn-outline-dark" id="BtnLoginUsername">
...
<script>
  ...
  const BtnLoginUsername = document.getElementById("BtnLoginUsername");
  if (x.style.display === "none") {
    x.style.display = "block";
    logo.style.display = "none";
    BtnLoginUsername.style.display = "none";
  } else {
    x.style.display = "none";
    logo.style.display = "block";
    BtnLoginUsername.style.display = "block";
  }
  }
</script>