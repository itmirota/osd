...
<div class="d-flex flex-row justify-content-center mb-4 p-4" style="padding-top:5vh">
  <div class="col-3 m-1">
...
<div class="text-judul mt-2 mb-2">
  <h3 class="m-0"><i class="fa fa-list"></i> List Perizinan</h3>
  <p class="m-0">menampilkan histori perizinanmu</p>
</div>
<div class="row m-2">
  <div class="col-md-12 card p-0">
    ...
    <div id="approval-cuti" class="tabcontent table-responsive">
      <table class="table table-hover">
        <thead>
        <tr>
          <th>No.</th>
