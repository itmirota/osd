...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="d-flex justify-content-end mb-4">
      <button class="btn btn-primary " type="button" data-bs-toggle="modal" data-bs-target="#ModalAddUser"><i class="fa fa-add"></i> Booking Ruangan</button>
    </div>
      ...
      <table id="dataTable" class="table table-hover">
        ...
        <tr>
          ...
          <td class="text-center">
            ...
            <a href="<?= base_url('deletePinjamRuangan/'.$data->id_pinjam_ruangan) ?>" class="btn btn-sm btn-danger" ><i class="fa fa-trash"></i></a></td>
          <?php } ?>
        </tr>
        <?php
          endforeach;
...
<div class="modal fade" id="ModalAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?=base_url('Ruangan/booking')?>" role="form" id="ModalAdd" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="text" name="nama_peminjam" class="form-control tabel-PR" />
            </div>
            <div class="col-md-6">
